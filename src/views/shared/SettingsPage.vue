...
<template>
 ...
 <!-- Current password -->
 <div>
 <label for="set-current-pw" class="block text-sm font-bold text-slate-700 mb-1.5">Current password</label>
 <div class="relative">
 <input
 id="set-current-pw"
 ...
 :class="pwErrors.currentPassword ? 'border-rose-500 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 bg-rose-50/50' : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
 <button
 type="button"
 ...
 <!-- New password -->
 <div>
 <label for="set-new-pw" class="block text-sm font-bold text-slate-700 mb-1.5">New password</label>
 <div class="relative">
 <input
 id="set-new-pw"
 ...
 placeholder="••••••••"
 class="w-full px-4 py-3 pr-16 text-sm border rounded-xl outline-none transition-all duration-300 bg-slate-50 "
 :class="pwErrors.newPassword ? 'border-rose-500 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 bg-rose-50/50' : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
 <button
 type="button"
 ...
 <!-- Confirm password -->
 <div>
 <label for="set-confirm-pw" class="block text-sm font-bold text-slate-700 mb-1.5">Confirm new password</label>
 <input
 id="set-confirm-pw"
 ...
 :class="pwErrors.confirmPassword ? 'border-rose-500 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 bg-rose-50/50' : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
