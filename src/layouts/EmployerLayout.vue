...
<template>
 ...
 <!-- Mobile Header -->
 <header class="md:hidden flex items-center justify-between p-4 bg-white border-b border-slate-200/60 shadow-sm z-10 relative">
 <router-link to="/employer/dashboard" class="text-lg font-extrabold text-[#007070] tracking-tight">VietRecruit</router-link>
 ...
 >
 <div class="hidden md:flex items-center justify-between px-6 py-5 border-b border-slate-200/60 ">
 <router-link to="/employer/dashboard" class="text-xl font-extrabold text-[#007070] tracking-tight">VietRecruit</router-link>
 <button @click="toggleTheme" class="text-slate-400 hover:text-teal-600 :text-teal-400 transition-colors p-1" aria-label="Toggle dark mode">
 <span v-if="isDark">☀️</span>
 <span v-else>🌙</span>
 </button>
 </div>
 ...
 <span class="text-sm font-bold text-slate-700 block truncate">{{ auth.user?.fullName ?? 'Employer' }}</span>
