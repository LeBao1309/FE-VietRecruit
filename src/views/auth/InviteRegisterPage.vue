...
<template>
 ...
 <!-- Auth Header -->
 <header class="sticky top-0 z-50 flex items-center justify-center h-14 px-4 bg-white/95 backdrop-blur-md border-b border-slate-200/60 shadow-sm">
 ...
 <h1 class="text-2xl font-bold text-slate-900 ">Accept invitation</h1>
 ...
 <!-- Full Name -->
 <div>
 <label for="invite-name" class="block text-sm font-bold text-slate-700 mb-1.5">Full name</label>
 <input
 id="invite-name"
 ...
 <!-- Password -->
 <div>
 <label for="invite-pw" class="block text-sm font-bold text-slate-700 mb-1.5">Password</label>
 <div class="relative">
 <input
 id="invite-pw"
 ...
 <!-- Confirm Password -->
 <div>
 <label for="invite-confirm" class="block text-sm font-bold text-slate-700 mb-1.5">Confirm password</label>
 <input
 id="invite-confirm"
