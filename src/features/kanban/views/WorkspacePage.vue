...
<template>
  <div
    class="min-h-screen bg-surface flex flex-col items-center justify-center px-6 text-center"
  >
    <div
    ...
    <div class="relative z-10 max-w-md">
      <div class="flex items-center justify-center gap-2.5 mb-8">
        <img
          ...
          class="h-8"
        />
        <span class="font-semibold text-white">VietRecruit</span>
      </div>
      ...
      <button
        type="button"
        class="bg-brand hover:bg-brand-dark text-white font-semibold px-6 py-3 rounded-lg transition-all duration-200 hover:shadow-brand-glow"
