...
<template>
 ...
 <p class="text-sm text-slate-500 mt-1">View details of your transactions and payment activity</p>
 </div>
 ...
 <p class="text-slate-500">Loading transaction history...</p>
 </div>
 ...
 <h2 class="text-base font-bold text-slate-800 mb-1">No Transactions Yet</h2>
 <p class="text-sm text-slate-400 max-w-xs mx-auto">Payment history will appear here after you subscribe to a plan.</p>
 ...
 <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Transaction ID</th>
 <th class="py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Date & Time</th>
