...
<template>
  <div class="max-w-6xl mx-auto px-6 py-8 md:px-8">
    ...
    <div class="flex items-start justify-between mb-6">
      <div>
        <h1 class="text-xl font-bold text-slate-900 dark:text-white">Job Listings</h1>
        ...
        <div v-if="quotaText" class="mt-3 flex items-center gap-2">
          <div class="flex-1 w-48 h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
            <div
    ...
    <!-- Table -->
    <div v-else class="bg-surface border border-slate-200/60 dark:border-slate-700 rounded-2xl shadow-sm overflow-hidden">
      <div class="overflow-x-auto w-full">
        <table class="w-full whitespace-nowrap text-left">
          <thead>
            <tr class="border-b border-slate-200/60 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-slate-500 uppercase tracking-wider text-[11px] font-bold">
        ...
        <tbody>
          ...
          >
            <td class="px-5 py-4">
              <span class="text-sm font-semibold text-slate-900 dark:text-white group-hover:text-teal-700 transition-colors">{{ job.title }}</span>
            </td>
            <td class="px-5 py-4">
              <span
