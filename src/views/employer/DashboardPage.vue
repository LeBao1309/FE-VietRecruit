...
<template>
 ...
 <p class="text-sm text-gray-500 mt-1">Overview of the recruitment pipeline and key metrics.</p>
 </div>
 ...
 <h2 class="text-sm font-bold text-slate-900 ">Active Job Limit</h2>
 ...
 Cycle: {{ quota.cycleStart ? new Date(quota.cycleStart).toLocaleDateString('en-US') : '—' }} – {{ quota.cycleEnd ? new Date(quota.cycleEnd).toLocaleDateString('en-US') : '—' }}
 </p>
 ...
 <span class="font-medium">Job limit reached.</span>
