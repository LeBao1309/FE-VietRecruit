...
<template>
 ...
 : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
 ...
 <router-link to="/forgot-password" class="text-xs font-bold text-teal-600 hover:text-teal-500 :text-teal-300 transition-colors">
 Forgot password?
 </router-link>
 </div>
 <div class="relative">
 ...
 <span class="bg-white px-4 text-slate-400 uppercase tracking-wider">or continue with</span>
 </div>
 </div>
 ...
 class="flex items-center justify-center gap-2 px-4 py-3 text-sm font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl hover:bg-white :bg-slate-800 hover:border-slate-300 :border-slate-600 hover:-translate-y-0.5 hover:shadow-sm transition-all duration-300"
 >
