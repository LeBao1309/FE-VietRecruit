...
<template>
 ...
 <h2 class="text-lg font-bold text-slate-900 ">About You</h2>

 <div>
 <label for="headline" class="block text-sm font-bold text-slate-700 mb-2">Headline</label>
 <input
 id="headline"
 ...
 <!-- Skills -->
 <div class="premium-card p-8 space-y-6">
 <h2 class="text-lg font-bold text-slate-900 ">Skills & Experience</h2>
 ...
 <div>
 <label for="position-level" class="block text-sm font-bold text-slate-700 mb-2">Position Level</label>
 <select
 id="position-level"
 ...
 <div class="premium-card p-8 space-y-6">
 <h2 class="text-lg font-bold text-slate-900 ">Education & Preferences</h2>
 ...
 <div>
 <label for="edu-major" class="block text-sm font-bold text-slate-700 mb-2">Major / Field</label>
 <input
 id="edu-major"
 ...
 <div>
 <label for="available-from" class="block text-sm font-bold text-slate-700 mb-2">Available From</label>
 <input
 id="available-from"
 ...
 <!-- Salary Expectations -->
 <div class="premium-card p-8 space-y-6">
 <h2 class="text-lg font-bold text-slate-900 ">Salary Expectations</h2>
