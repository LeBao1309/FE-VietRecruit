...
<template>
 ...
 class="w-full p-5 border border-slate-200 rounded-xl text-left hover:border-teal-500 :border-teal-500 hover:bg-teal-50 :bg-teal-900/20 hover:-translate-y-0.5 hover:shadow-sm transition-all duration-300 group bg-slate-50 "
 >
 <div class="font-bold text-slate-900 group-hover:text-teal-600 :text-teal-400 transition-colors">
 ...
 :class="errors.fullName ? 'border-rose-500 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 bg-rose-50/50' : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
 ...
 class="w-full px-4 py-3 text-sm border rounded-xl outline-none transition-all duration-300 bg-slate-50 "
 :class="errors.email ? 'border-rose-500 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 bg-rose-50/50' : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
 ...
 :class="errors.password ? 'border-rose-500 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 bg-rose-50/50' : 'border-slate-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:bg-white :bg-slate-900'"
 />
 <button
 type="button"
